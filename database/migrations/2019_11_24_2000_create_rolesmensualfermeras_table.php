...
class CreateRolesmensualenfermerasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rolesmensualenfermeras', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('rolesmensualenfermeras');
    }
}
